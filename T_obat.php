...
<script>
    ...
    function ubahBuku(i) {
        $("#bukuModal").modal("show");
        $("#titleModal").html("Ubah");
        $("#id").val(jsonBuku[i].id);
        $("#kd_baranggu").val(jsonBuku[i].kd_baranggu);
        $("#nama_baranggu").val(jsonBuku[i].nama_baranggu);
        $("#harga").val(jsonBuku[i].hargagu);
